...
let ecdh_base: out:int array -> secret:secret key -> unit = fun ~out ~secret -> curve25519_base out secret
let ecdh: out:int array -> secret:secret key -> public:public key -> unit = fun ~out ~secret ~public -> curve25519 out secret public
...
let shared
  : secret:secret key -> public:public key -> public key
