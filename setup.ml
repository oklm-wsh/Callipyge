...
(* OASIS_START *)
(* DO NOT EDIT (digest: db9d7fad2fc1a78b58ed0d81ba76b2ca) *)
(*
...
let setup_t =
  {
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$safe_test", []))];
          ...
          ("unsafe",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$unsafe_test", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/oklm-wsh/Callipyge";
          synopsis = "Curve25519";
          description =
            Some [OASISText.Para "Pure OCaml Library for Curve25519"];
          categories = [];
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Example of use Callipyge";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "callipyge"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "safe.ml"});
               Test
                 ({
                     cs_name = "safe";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "unsafe.ml"});
               Test
                 ({
                     cs_name = "unsafe";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "unsafe_test"
                        ]
                   });
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/oklm-wsh/Callipyge.git";
                      src_repo_browser =
                        Some "https://github.com/oklm-wsh/Callipyge";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "H*?#\215\185\209\2454\174q?\217\151\183\212";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
